        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li className="">
              ...
              <li className="">
                {isloggedIn ? (
                <>
                 <li className="logout" style={{ cursor: "pointer" }}>{have_email}</li>
                </>
                ): (<Link to="/login">
                <i
                  class="fa fa-user-o"
            ...
            <li className="_active ">
              ...
              <li className=""  >
                <a  target="_blank" href="https://www.amazon.in/?tag=msndeskabkin-21&hvadid=72155527817002&hvqmt=e&hvbmt=be&hvdev=c&ref=pd_sl_4jqua56skg_e" >
                  Shop
                </a>
              </li>
              <li className="">
